package com.wufu.exrobots.voice;
...
import com.wufu.exrobots.JsonFormat;
import com.wufu.exrobots.R;

/**
 * Created by Enid on 2017/6/1.
 */
...
public class SpeechActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    private static final String PREFER_NAME = "ex_robots_setting";
    private Toast mToast;
    private EditText mInputText,mUnderstanderText;
    // 语义理解对象（语音到语义）。
    ...
    private void init() {
         ...
         */
        // 初始化对象
        mSpeechUnderstander = SpeechUnderstander.createUnderstander(SpeechActivity.this, mSpeechUdrInitListener);
        mTextUnderstander = TextUnderstander.createTextUnderstander(SpeechActivity.this,mTextUdrInitListener);
        mToast = Toast.makeText(SpeechActivity.this, "", Toast.LENGTH_SHORT);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.text_understander://文本理解
            ...
            case R.id.start_understander://语音理解
                mUnderstanderText.setText("");
                // 设置参数
                setParam();
        ...
        public void onResult(final UnderstanderResult result) {
            if (null != result) {
                ...
                if (!TextUtils.isEmpty(text)) {
                    ...
                    Log.d(TAG, JsonFormat.format(text));
                }
            } else {
